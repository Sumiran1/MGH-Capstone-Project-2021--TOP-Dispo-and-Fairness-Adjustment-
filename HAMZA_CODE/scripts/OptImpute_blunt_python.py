...
train_X_time = pd.read_csv(data_path+"trauma_X_train_time_blunt.csv")
test_X_time = pd.read_csv(data_path+"trauma_X_test_time_blunt.csv")
...
lnr_optimpute_blunt.fit(X_time)
